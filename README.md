...
| `testing` | Choose tests for their concrete regression value and avoid low-value coverage. Use during implementation, fixes, planning, diagnosis, and code review when choosing verification, adding or changing tests, or considering a missing-test finding. |  |  |
