...
Treat `${ARGUMENTS}` as the feature, change, plan, or decision to grill. If it is empty, use the current conversation context; if the target is still unclear, ask one question to identify it.
